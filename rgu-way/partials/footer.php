    ...
    <div class="grid gap-12 pb-12 
      ...
      <div>
        ...
        <div class="mb-6 flex flex-wrap gap-2">
          ...
          <!-- LinkedIn -->
          <a href="https://www.linkedin.com/company/rathinam-global/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/40 transition hover:bg-white/10 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <!-- Facebook -->
          <a href="https://www.facebook.com/rathinamglobal/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/40 transition hover:bg-white/10 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <!-- Instagram -->
          <a href="https://www.instagram.com/rathinam_global/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/40 transition hover:bg-white/10 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div>
        ...
        <ul class="space-y-3">
          ...
          <li><a href="https://rathinamglobal.edu.in/fab/" class="text-sm text-white/45 transition hover:text-white">RGU Summer Camp - 2026</a></li>
