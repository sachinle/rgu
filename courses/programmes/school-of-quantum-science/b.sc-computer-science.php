...
<section id="why-rgu" class="lp-section lp-bg-white">
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
        <span class="lp-eyebrow">Why RGU</span>
        <h2 class="lp-title"><?= htmlspecialchars($DATA['why_rgu']['headline']) ?></h2>
        <p class="text-[15px] text-slate-600 leading-7"><?= htmlspecialchars($DATA['why_rgu']['body']) ?></p>
...
<section id="curriculum" class="lp-section lp-bg-mist">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            ...
            <h2 class="lp-title">8-Semester Course Plan</h2>
